...
#   V1: "Metastatic epidural spinal cord compression with cauda equina
#       syndrome" -- VIOLATION.
#   V2: "Cauda equina syndrome due to metastatic spinal cord compression"
#       -- VIOLATION.
#   V3: "Androgen-secreting tumor (e.g., adrenal or ovarian origin)" --
#       VIOLATION.
#
# openai/gpt-4o-mini:
#   V1: "Gait disorders secondary to neurological involvement from Crohn's
#       disease" -- VIOLATION (vague, non-committal cause rather than a
#       named diagnosis).
#   V2: "Ovarian Tumor (likely sex-cord-stromal tumor or granulosa cell
#       tumor)" -- VIOLATION (unresolved alternative). "Cerebellar ataxia
#       due to multiple sclerosis" -- VIOLATION
#   V3: "Ovarian tumor (such as a sex-cord stromal tumor or germ cell
#       tumor causing precocious puberty)" -- VIOLATION. "Neuropathy
#       related to Crohn's disease" -- VIOLATION, same pattern as
#       cerebellar ataxia/MS above.
MANUAL_EXTRANEOUS_DIAGNOSIS_CONTENT_COUNTS = {
    "deepseek/deepseek-r1": {"V1": 1, "V2": 1, "V3": 1},
    "openai/gpt-4o-mini": {"V1": 1, "V2": 2, "V3": 2},
}
